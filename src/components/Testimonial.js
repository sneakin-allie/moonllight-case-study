import { StyledTestimonial, StyledQuote, StyledClient, ThreeSquares, WhiteLines, WhiteSquaresX, X, DarkGreenSquare, LgMintSquare, GrayLines, SmMintSquare, OmbreSquares, Quotation, SmGreenSquare, FiveSquares, SmWhiteSquare, WindowPanes, LgPaleMintSquare, WhiteBGGrid, GreenBGGrid } from "./styles/Testimonial.styled";
    ...
    return (
        <StyledTestimonial>
            ...
            <GreenBGGrid>
                ...
                <ThreeSquares width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <SmWhiteSquare />
                <OmbreSquares width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <defs>
                    <linearGradient id="paint0_linear_2246_1156" x1="0" y1="0" x2="128" y2="11" gradientUnits="userSpaceOnUse">
                ...
                <LgPaleMintSquare />
                <StyledQuote>
                    <Quotation width="48" height="36" viewBox="0 0 48 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <FiveSquares width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="1" y="1" width="16" height="16" stroke="#7B9291"/>
                    <rect x="1" y="33" width="16" height="16" stroke="#7B9291"/>
                    <rect x="17" y="1" width="16" height="16" stroke="#7B9291"/>
                    <rect x="33" y="17" width="16" height="16" stroke="#7B9291"/>
                    <rect x="33" y="33" width="16" height="16" stroke="#7B9291"/>
                </FiveSquares>
                <SmGreenSquare />
                <WindowPanes width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <rect opacity="0.1" y="39.2725" width="13.0909" height="13.0909" fill="#BEF0DB"/>
                    <rect opacity="0.1" y="58.9092" width="13.0909" height="13.0909" fill="#BEF0DB"/>
                    <rect opacity="0.1" x="19.6365" width="13.0909" height="13.0909" fill="#BEF0DB"/>
                    <rect opacity="0.1" x="19.6365" y="19.6367" width="13.0909" height="13.0909" fill="#BEF0DB"/>
                    <rect opacity="0.1" x="19.6365" y="39.2725" width="13.0909" height="13.0909" fill="#BEF0DB"/>
                    <rect opacity="0.1" x="19.6365" y="58.9092" width="13.0909" height="13.0909" fill="#BEF0DB"/>
                    ...
                    <rect opacity="0.1" x="39.2727" y="39.2725" width="13.0909" height="13.0909" fill="#BEF0DB"/>
                    <rect opacity="0.1" x="39.2727" y="58.9092" width="13.0909" height="13.0909" fill="#BEF0DB"/>
                ...
                <StyledClient>  
                    ...
                    <X width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M9.89949 7.07121L7.07107 9.89964L14.1421 16.9707L7.07107 24.0418L9.89949 26.8702L16.9706 19.7991L24.0416 26.8702L26.8701 24.0418L19.799 16.9707L26.8701 9.89963L24.0416 7.07121L16.9706 14.1423L9.89949 7.07121Z" fill="url(#paint0_linear_2161_1229)"/>
                    <defs>
                    <linearGradient id="paint0_linear_2161_1229" x1="8.48528" y1="8.48542" x2="25.4558" y2="25.456" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#7EE8B9" stop-opacity="0.5"/>
                    <stop offset="1" stop-color="#83E4B9" stop-opacity="0"/>
                    <stop offset="1" stop-color="#7EE8B9" stop-opacity="0.1"/>
                    </linearGradient>
                ...
                <WhiteSquaresX width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg">
