import { StyledTestimonial, StyledQuote, StyledClient, ThreeSquares, WhiteLines, WhiteSquaresX, X, DarkGreenSquare, LgMintSquare, GrayLines, SmMintSquare, OmbreSquares, Quotation, SmGreenSquare, FiveSquares, SmWhiteSquare, WindowPanes, LgPaleMintSquare } from "./styles/Testimonial.styled";
...
export default function Testimonial() {
    return (
        <StyledTestimonial>
            ...
            <ThreeSquares width="33" height="49" viewBox="0 0 33 49" fill="none" xmlns="http://www.w3.org/2000/svg">
